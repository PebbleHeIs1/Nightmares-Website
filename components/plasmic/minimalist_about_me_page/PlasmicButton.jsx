...
import sty from "./PlasmicButton.module.css"; // plasmic-import: r2g7-8qXxm_/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: WVWBJI8hsMU/icon
import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: Sgosjnnkft9/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__kxwer)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon4Icon
                className={classNames(projectcss.all, sty.svg__bb61J)}
                role={"img"}
              />
            ),
